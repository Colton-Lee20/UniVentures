            ...
            <section className="py-16">
                <div className="max-w-7xl mx-auto px-6 md:px-16">
                    <div className="text-center">
                        <h1 className="text-white font-bold uppercase text-5xl">One More Step...</h1>
                        <p className="text-2xl text-gray-200 mt-4 text-lg">
                            And then the world is yours.
                        </p>
                        <div className="h-0.5 bg-teal-700 w-16 mx-auto mt-6"></div>
                        <p className="text-gray-200 mt-20 text-lg">
